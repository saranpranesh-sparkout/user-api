...
var createUser = exports.createUser = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(req, res) {
    var _req$body, name, age, email, isAdmin, newUser, _t;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        case 0:
          _context.p = 0;
          _req$body = req.body, name = _req$body.name, age = _req$body.age, email = _req$body.email, isAdmin = _req$body.isAdmin;
          _context.n = 1;
...
var updateUser = exports.updateUser = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee4(req, res) {
    var _req$body2, name, email, age, isAdmin, updatedUser, _t4;
    return _regenerator().w(function (_context4) {
      while (1) switch (_context4.p = _context4.n) {
        case 0:
          _context4.p = 0;
          _req$body2 = req.body, name = _req$body2.name, email = _req$body2.email, age = _req$body2.age, isAdmin = _req$body2.isAdmin;
          _context4.n = 1;
          return _userModel["default"].findByIdAndUpdate(req.params.id, {
            name: name,
            email: email,
            age: age,
            isAdmin: isAdmin
...
var deleteUser = exports.deleteUser = /*#__PURE__*/function () {
  ...
  return function deleteUser(_x9, _x0) {
